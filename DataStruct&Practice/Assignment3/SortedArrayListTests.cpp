...
TEST(SortedArrayList_Dynamic_Duplicate, listEmptyInitializationTest2)
{
...
TEST(SortedArrayList_Dynamic_Duplicate, removeAllTest2)
{
	SortedArrayList list{1, 2, 3, 4, 5};
	//list.removeAll(6); //예외 출력
	list.removeAll(2);
	std::string output = "";
		for(auto n: list) {
...
TEST(SortedArrayList_Dynamic_Duplicate, listEmptyInitializationTest)
{
	SortedArrayList list{};
	ASSERT_EQ(list.size(), 0);
...
TEST(SortedArrayList_Dynamic_Duplicate, addfindTest)
{
	SortedArrayList list;
	list.add(3);
	list.add(5);
...
TEST(SortedArrayList_Dynamic_Duplicate, popTest)
{
	SortedArrayList list;
	list.add(3);
	list.add(5);
...
TEST(SortedArrayList_Dynamic_Duplicate, listInitializationTest)
{
...
TEST(SortedArrayList_Dynamic_Duplicate, findTest) {
...
TEST(SortedArrayList_Dynamic_Duplicate, removeFirstTest) {
...
TEST(SortedArrayList_Dynamic_Duplicate, removeAllTest) {
...
TEST(SortedArrayList_Dynamic_Duplicate, iteratorTest) {
	SortedArrayList list;
	list.add(3);
	list.add(5);
	list.add(7);
...
TEST(SortedArrayList_Dynamic_Duplicate, IndexOperator) {
	SortedArrayList list;
	list.add(3);
	list.add(5);
	ASSERT_EQ(list[1], 5);
...
TEST(SortedArrayList_Dynamic_Duplicate, clearTest) {
...
TEST(SortedArrayList_Dynamic_Duplicate, Big5)
{
